  ...
  return (
    <table className="mx-auto border-collapse w-full overflow-hidden">
      ...
      <tr className="bg-[#93FFDC]">
        <th className="px-[22px] py-4 border-b border-[#d9d9d9] text-[1rem]">공항</th>
        <th className="px-[22px] py-4 border-b border-[#d9d9d9] text-[1rem]">처리 시각</th>
        <th className="px-[22px] py-4 border-b border-[#d9d9d9] text-[1rem]">전체 평균</th>
        <th className="px-[22px] py-4 border-b border-[#d9d9d9] text-[1rem]">체크인 & 수화물</th>
        <th className="px-[22px] py-4 border-b border-[#d9d9d9] text-[1rem]">신원확인</th>
        <th className="px-[22px] py-4 border-b border-[#d9d9d9] text-[1rem]">보안검사</th>
        <th className="px-[22px] py-4 border-b border-[#d9d9d9] text-[1rem]">비행기 탑승</th>
      </tr>
      </thead>
      <tbody>
      {data.map((item, i) => (
        <tr key={i} className="hover:bg-[#f9f9f9]">
          <td className="text-center px-[22px] py-4 border-b border-[#d9d9d9]">{item.airport_code}</td>
